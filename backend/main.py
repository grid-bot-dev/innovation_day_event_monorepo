...
from backend import backend_logic
...
async def get_portfolio_overview():
    return await backend_logic.get_portfolio_overview()
...
async def get_risk_metrics():
    return await backend_logic.get_risk_metrics()

@app.get("/api/get_performance_dashboard")
async def get_performance_dashboard():
    return await backend_logic.get_performance_dashboard()

@app.get("/api/get_compliance_summary")
async def get_compliance_summary():
    return await backend_logic.get_compliance_summary()
